  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button:
          "h-11 w-11 min-h-[44px] min-w-[44px] bg-transparent p-0 opacity-50 hover:opacity-100 text-muted-foreground",
        ...
        cell: cn(
          "relative h-11 w-11 min-h-[44px] min-w-[44px] text-center text-sm p-0 font-normal focus-within:relative focus-within:z-20",
